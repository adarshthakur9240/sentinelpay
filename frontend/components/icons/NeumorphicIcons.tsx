    ...
    >
      <defs>
        ...
        <filter id="neuSoftBevel" x="-20%" y="-20%" width="140%" height="140%">
          ...
          <feDropShadow dx="-1" dy="-1" stdDeviation="1.2" floodColor="#FFFFFF" floodOpacity="0.08" />
        </filter>
      </defs>
      {/* Outer Clay Disc */}
      <circle cx="14" cy="14" r="12" fill="url(#neuRadarRim)" filter="url(#neuSoftBevel)" stroke="rgba(255,255,255,0.06)" strokeWidth="1" />
      {/* Mid Ring Emboss */}
      ...
      <circle cx="19.5" cy="9.5" r="1.8" fill="#D4C8EB" />
      <circle cx="19.5" cy="9.5" r="3.2" stroke="#D4C8EB" strokeWidth="0.8" strokeOpacity="0.5" />
    </svg>
  );
}
    ...
    >
      <defs>
        ...
        <filter id="neuPillBevel">
          <feDropShadow dx="1" dy="1.5" stdDeviation="1" floodColor="#000000" floodOpacity="0.5" />
          <feDropShadow dx="-0.8" dy="-0.8" stdDeviation="0.8" floodColor="#FFFFFF" floodOpacity="0.1" />
        </filter>
      </defs>
      {/* Background Plate */}
      <rect x="2" y="2" width="24" height="24" rx="7" fill="url(#neuTreeRim)" filter="url(#neuPillBevel)" stroke="rgba(255,255,255,0.06)" />
      {/* Root Node */}
      ...
      {/* Split Nodes */}
      <circle cx="8" cy="15" r="2" fill="#D4C8EB" />
      <circle cx="20" cy="15" r="2" fill="#B5D8C5" />
      {/* Child Branches */}
      <path d="M8 17 L5.5 21.5 M8 17 L10.5 21.5 M20 17 L17.5 21.5 M20 17 L22.5 21.5" stroke="#9A9AA4" strokeWidth="1.2" strokeLinecap="round" strokeOpacity="0.5" />
      {/* Leaf Nodes */}
      <circle cx="5.5" cy="22" r="1.5" fill="#F2B8C6" />
      <circle cx="10.5" cy="22" r="1.5" fill="#B5D8C5" />
      <circle cx="17.5" cy="22" r="1.5" fill="#B5D8C5" />
      <circle cx="22.5" cy="22" r="1.5" fill="#D4C8EB" />
    </svg>
  );
}
...
export function NeumorphicShieldCheckIcon({ className = "", size = 26, ...props }: IconProps) {
  return (
    ...
    >
      <defs>
        <linearGradient id="neuShieldGreen" x1="0" y1="0" x2="28" y2="28" gradientUnits="userSpaceOnUse">
    ...
    >
      <defs>
        <linearGradient id="neuShieldRed" x1="0" y1="0" x2="28" y2="28" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#281A1E" />
...
export function NeumorphicSliderScaleIcon({ className = "", size = 26, ...props }: IconProps) {
  return (
    ...
    >
      ...
      {/* Outer Raised Plate */}
      <rect x="2" y="2" width="24" height="24" rx="7" fill="#14141A" stroke="rgba(255,255,255,0.06)" />
      {/* Inset Track 1 */}
      ...
      <circle cx="18" cy="17.5" r="3.2" fill="#D4C8EB" stroke="#FFFFFF" strokeWidth="1" />
    </svg>
  );
}
...
export function NeumorphicSpikeIcon({ className = "", size = 26, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <rect x="2" y="2" width="24" height="24" rx="7" fill="url(#neuSpikeBg)" stroke="rgba(255,255,255,0.06)" />
      ...
      />
      {/* Peak Anomaly Circle */}
      <circle cx="14" cy="7" r="2.2" fill="#D4C8EB" stroke="#FFFFFF" strokeWidth="0.8" />
    </svg>
  );
}
